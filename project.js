...
rtl.module("program",["System","browserapp","JS","Classes","SysUtils","Web"],function () {
  ...
  this.button = null;
  this.setup = function () {
    $mod.title = document.body.appendChild(document.createElement("h1"));
    $mod.button = document.body.appendChild(document.createElement("button"));
  };
  this.buildUI = function () {
    $mod.title.innerHTML = "Đây là cái web viết bằng Kode";
    $mod.button.innerHTML = "OK";
  };
